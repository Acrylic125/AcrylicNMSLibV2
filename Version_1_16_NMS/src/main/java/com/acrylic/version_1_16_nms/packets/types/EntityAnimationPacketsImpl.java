...
public class EntityAnimationPacketsImpl
    ...
    public EntityAnimationPackets attachLeftArmSwingingAnimation(@NotNull Entity entity) {
        packets.add(getNewLeftArmSwingPacket(entity));
        return this;
    }

    @Override
    public PacketPlayOutAnimation getNewLeftArmSwingPacket(@NotNull Entity entity) {
        return new PacketPlayOutAnimation(NMSUtils.convertToNMSEntity(entity), 3);
    }
    ...
    @Override
    public PacketPlayOutEntityMetadata getNewSleepPacket(@NotNull Entity entity, @NotNull Location location) {
    ...
    @Override
    public PacketPlayOutEntityMetadata getNewSleepPacket(@NotNull Entity entity) {
    ...
    public PacketPlayOutEntityMetadata generateSneakPacket(@NotNull net.minecraft.server.v1_16_R3.Entity entity, boolean sneaking) {
