...
public class PlayerInfoPacketImpl
    ...
    public void apply(@NotNull Info info, @NotNull net.minecraft.server.v1_16_R3.EntityPlayer player) {
        packetPlayOutPlayerInfo = new PacketPlayOutPlayerInfo(toNMSInfo(info), player);
    }

    public void apply(@NotNull Info info, @NotNull net.minecraft.server.v1_16_R3.EntityPlayer... players) {
