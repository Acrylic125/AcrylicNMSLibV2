...
public class EntityOrientationPacketsImpl
    ...
    public void apply(net.minecraft.server.v1_16_R3.Entity entity, float yaw, float pitch) {
        getPackets().clear();
        applyLookOrientation(entity, yaw, pitch);
        applyHeadOrientation(entity, yaw);
    }

    public void applyLookOrientation(net.minecraft.server.v1_16_R3.Entity entity, float yaw, float pitch) {
    ...
    public void applyHeadOrientation(net.minecraft.server.v1_16_R3.Entity entity, float yaw) {
